  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="#">Penanganan Gangguan Cabai</a></li>
        ...
        <div class="container">
            <div class="row">
                <center><h3>Gejala Gangguan Tanaman Cabai</h3></center>
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <td class="info"><center>No.</center></td>
                                <td class="info"><center>Cara Penanganan Gejala Gangguan Cabai</center></td>
                                <td class="info"><center>Keterangan Penanganan Gejala Gangguan Cabai</center></td>
                        </thead>
                        <tbody>
                            <?php
                                $no = 1;
